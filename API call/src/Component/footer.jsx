      ...
      <div className="container py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted max-w-md mx-auto">
            Connecting people through amazing content and meaningful conversations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="footer-section">
            ...
            <Link to="/post" className="footer-link">Posts</Link>
            <Link to="/user" className="footer-link">Users</Link>
            <Link to="/albums" className="footer-link">Albums</Link>
            <Link to="/photo" className="footer-link">Photos</Link>
          </div>
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-subtle">
              © {currentYear} JungleBook. All rights reserved.
            </p>
